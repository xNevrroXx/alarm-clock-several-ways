...
const easing = {
  ...
  class IosSelector {
      ...
      if (this.options.type === 'infinite') {
        ...
        for (let i = 0; i < this.quarterCount; i++) {
          ...
          circleListHTML = `<li class="select-option"
                        ...
                        "
                        data-index="${-i - 1}"
                        >${source[sourceLength - i - 1].value}</li>` + circleListHTML;
          // 尾
          circleListHTML += `<li class="select-option"
                        style="
                          top: ${this.itemHeight * -0.5}px;
        ...
        // 高亮头尾
        highListHTML = `<li class="highlight-item" style="height: ${this.itemHeight}px;">
                            ${source[sourceLength - 1].value}
                        </li>` + highListHTML;
        highListHTML += `<li class="highlight-item" style="height: ${this.itemHeight}px;">${source[0].value}</li>`
      }
    ...
    _moveTo(scroll) {
      ...
      this.elems.highlightList.style.transform = `translate3d(0, ${-(scroll) * this.itemHeight - 2}px, 0)`;
  ...
  // yearSource = getHours();
  // monthSource = getMinutes();
  // daySource = getSeconds();
  ...
  //         // daySource = getHours(currentYear, currentMonth);
